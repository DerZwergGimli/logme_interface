...
void ota_example_task(void *pvParameter) {
    ...
    esp_http_client_config_t config = {
            .url = CONFIG_LOGME_FIRMWARE_UPG_URL,
            .cert_pem = (char *) server_cert_pem_start,
            .timeout_ms = CONFIG_LOGME_OTA_RECV_TIMEOUT,
...
bool diagnostic(void) {
    ...
    io_conf.pin_bit_mask = (1ULL << CONFIG_LOGME_GPIO_DIAGNOSTIC);
    ...
    bool diagnostic_is_ok = gpio_get_level(CONFIG_LOGME_GPIO_DIAGNOSTIC);

    gpio_reset_pin(CONFIG_LOGME_GPIO_DIAGNOSTIC);
